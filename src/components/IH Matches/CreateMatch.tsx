...
const CreateMatch: React.FC = () => {
  ...
  return (
    <div>
      ...
      <h1 className="mb-4" style={{ fontSize: "25px", fontWeight: 700,marginLeft:'100px',marginTop:'50px' }}>
        ...
        <p style={{ fontSize: "16px", textAlign: "center", color: "grey",marginBottom:'50px' }}>
          Create and customise the football matches, teams to trophies!
        </p>
     
      <form onSubmit={handleSubmit} className="p-4 " style={{display:'flex',justifyContent:'center',flexDirection:'column',marginLeft:'100px'}}>
        ...
        <div className="mb-3">
          <label htmlFor="isAllDay" className="mr-2">All Day Event</label>
          <input
            type="checkbox"
            id="isAllDay"
            checked={isAllDay}
        ...
        <IconField iconPosition="left" className="mb-3 input-box-pr">
          <InputIcon className="pi pi-football" />
          <Dropdown
            id="typeOfSport"
            value={typeOfSport}
        ...
        <Button type="submit" label="Create Match"  style={{height:'50px',width:'460px',backgroundColor:'#051da0',borderRadius:'15px',color:'white',marginLeft:'5px',marginTop:'20px'}} />
      </form>
