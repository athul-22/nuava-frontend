      ...
      items: [
        {
          label: "Football",
          icon: "pi pi-calendar",
          command: () => handleOptionClick("Football"),
        },
        {
          label: "Basketball",
          icon: "pi pi-calendar",
          command: () => handleOptionClick("Basketball"),
        },
        {
          label: "Tennis",
          icon: "pi pi-calendar",
          command: () => handleOptionClick("Tennis"),
        },
      ],
    },
  ];
    ...
    <div className="navbar">
      <div className="navbar-content">
        ...
        <div className="right-section">
         ...
         <div style={{display:'flex',gap:'10px'}} className="icon-container">
         <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          {/* CALENDER */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 icon"  style={{color:'white'}}>
