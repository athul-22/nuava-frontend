  ...
  const coachDialogContent = () => (
    <div className="dialog-content" style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
      ...
      <center><Button
        ...
        style={{backgroundColor: '#051da0', color: 'white', marginRight: '10px',padding:'10px 60px',borderRadius:'20px'}}
      />
      <Button
        label="Login"
        onClick={() => window.location.href = "/coach/login"}
        className="p-button-secondary"
        style={{backgroundColor: 'white', color: '#051da0', marginRight: '10px',padding:'10px 60px',borderRadius:'20px',fontSize:'20px'}}
      /></center>
    </div>
  );
